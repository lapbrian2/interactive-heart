...
const AUSCULTATION_POINTS = [
  {
    name: 'Aortic Area',
    position: [0.2, 0.5, 0.4] as [number, number, number],
    valve: 'Aortic Valve',
  ...
  {
    name: 'Pulmonary Area',
    position: [-0.15, 0.5, 0.4] as [number, number, number],
  ...
  {
    name: "Erb's Point",
    position: [0.0, 0.25, 0.45] as [number, number, number],
    valve: 'Multiple',
  ...
  {
    name: 'Tricuspid Area',
    position: [0.1, 0.0, 0.45] as [number, number, number],
  ...
  },
  {
    ...
    position: [-0.15, -0.35, 0.45] as [number, number, number],
    valve: 'Mitral Valve',
